...
- Template to stamp from: `${CLAUDE_PLUGIN_ROOT}/template-en/` (skip `INDEX.md` and `kb-data.js`). If the variable is empty — use `template-en/` from the `knowledge-os` repo.
